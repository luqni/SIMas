...
<title>Mushola STT-NF | Blog</title>
<link rel="stylesheet" href="<?php echo base_url(); ?>assets2/css/blog.css">
  ...
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a id="logo" class="pull-left" href="three"></a>
      <div class="nav-collapse collapse pull-right">
        <ul class="nav">
          ...
          <li class="active"><a href="<?php echo site_url('Blog'); ?>">Artikel</a></li>
            ...
            <div class="span8">
                <div class="blog">
                    <div class="blog-item well">
                        <a href="#"><h2>Selamat Idul Fitri 1439 H</h2></a>
                      ...
                      <p><img src="<?php echo base_url(); ?>assets2/images/blog/hari-raya.gif" width="100%" alt="" /></p>
                  ...
                  <p><img src="<?php echo base_url(); ?>assets2/images/blog/blog2.jpg" width="100%" alt="" /></p>
                  <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
    ...
    <aside class="span4">
        ...
        <div class="widget ads">
            <div class="row-fluid">
                <div class="span6">
                    <a href="#"><img src="three/images/ads/ad1.png" alt=""></a>
                </div>

                <div class="span6">
                    <a href="#"><img src="three/images/ads/ad2.png" alt=""></a>
                </div>
            </div>
            <p> </p>
            <div class="row-fluid">
                <div class="span6">
                    <a href="#"><img src="three/images/ads/ad3.png" alt=""></a>
                </div>

                <div class="span6">
                    <a href="#"><img src="three/images/ads/ad4.png" alt=""></a>
                </div>
            </div>
        </div>
        <!-- /.ads -->
        ...
        <div class="widget widget-popular">
            ...
            <div class="widget-blog-items">
                ...
                <div class="widget-blog-item media">
                    ...
                    <div class="media-body">
                        <a href="#"><h5>Kajian Pra Nikah - Menyambut Syawal dengan Menikah</h5></a>
                    </div>
                </div>
                ...
                <div class="widget-blog-item media">
                    ...
                    <div class="media-body">
                        <a href="#"><h5>Kajian Rutin - Peningkatan Ibadah selepas Ramadhan</h5></a>
                    </div>
                </div>
...
</script><script src="three/js/all.js"></script>
</body>
</html>