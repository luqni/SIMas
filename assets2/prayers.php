...
<title>Free Islamic Templates | Prayers</title>
...
<link rel="stylesheet" href="three/css/uncss.css">
<script src="three/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>
<link rel="shortcut icon" href="three/favicon.ico">
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="three/images/ico/apple-touch-icon-144-precomposed.png">
    ...
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a id="logo" class="pull-left" href="three"></a>
      <div class="nav-collapse collapse pull-right">
        <ul class="nav">
          ...
          <li class="active"><a href="three-prayers">Prayers</a></li>
          <li><a href="three-templates">Templates</a></li>
          <li><a href="three-blog">Blog</a></li>
          <li><a href="three-services">Services</a></li>
          <li><a class="nav-gplus" href="https://plus.google.com/b/100537539023412941569/100537539023412941569/" target="_blank">Google+</a></li>
        </ul>
      </div>
    </div>
  </div>
